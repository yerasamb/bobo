...
const pageTranslations = {
  kk: {
    ...
    '📅 Events': '📅 Іс-шаралар', 'Upcoming Events': 'Алдағы іс-шаралар', 'Exciting activities, celebrations, and learning opportunities happening soon!': 'Жақында болатын қызықты сабақтар, мерекелер және танымдық мүмкіндіктер!', 'Spring Fun Fair': 'Көктемгі көңілді жәрмеңке', 'Our annual Spring Fun Fair with games, face painting, live music, and a bake sale. Families welcome!': 'Ойындар, бет әрлеу, жанды музыка және жәрмеңкесі бар жыл сайынғы көктемгі мереке. Барлық отбасыны күтеміз!', 'Details coming soon': 'Толығырақ жақында', 'STEM Showcase': 'STEM көрмесі', 'Children present their science projects to parents. Prepare to be amazed by our tiny scientists and engineers!': 'Балалар ата-аналарға ғылыми жобаларын ұсынады. Кішкентай ғалымдар мен инженерлерге таңданыңыз!', 'End-of-Year Graduation': 'Жыл соңындағы бітіру кеші', 'Celebrating our graduates as they move on to primary school. A ceremony full of pride, joy, and memories.': 'Бастауыш мектепке қадам басатын түлектерімізді мерекелеу. Мақтаныш, қуаныш және естелікке толы салтанат.',
  ...
  ru: {
    ...
    '📅 Events': '📅 События', 'Upcoming Events': 'Ближайшие события', 'Exciting activities, celebrations, and learning opportunities happening soon!': 'Скоро — интересные занятия, праздники и новые возможности для обучения!', 'Spring Fun Fair': 'Весенняя ярмарка', 'Our annual Spring Fun Fair with games, face painting, live music, and a bake sale. Families welcome!': 'Ежегодная весенняя ярмарка с играми, аквагримом, живой музыкой и выпечкой. Ждём всей семьёй!', 'Details coming soon': 'Подробности скоро', 'STEM Showcase': 'STEM-выставка', 'Children present their science projects to parents. Prepare to be amazed by our tiny scientists and engineers!': 'Дети представят родителям свои научные проекты. Приготовьтесь удивляться нашим маленьким учёным и инженерам!', 'End-of-Year Graduation': 'Выпускной в конце года', 'Celebrating our graduates as they move on to primary school. A ceremony full of pride, joy, and memories.': 'Празднуем переход выпускников в начальную школу. Торжество, полное гордости, радости и воспоминаний.',
