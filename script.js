...
const pageTranslations = {
  kk: {
    ...
    'Quality and quantity': 'Сапа және мүмкіндік', 'Neuro-exercise,Robotics,Salt cave,Choreography,Karate,Group speech therapy,Fairy tale therapy,Art therapy,Sensory integration,English,Online camera': 'Нейро-жаттығу, робототехника, тұзды шахта, хореография, каратэ, топтық логопед, ертегі терапиясы, арт-терапия, сенсорлық интеграция, ағылшын тілі, онлайн камера',
  ...
  'Subjects We Teach':'Қосымша сабақтар','Our comprehensive curriculum covers all developmental domains through play-based and structured learning.':'Біздің кешенді оқу бағдарламамыз ойынға негізделген және жүйеленген оқыту арқылы дамудың барлық саласын қамтиды.',
    'Neuro Development': 'Нейро бағыт',
  'A set of activities designed to support children’s attention, memory, thinking, coordination and cognitive development.': 'Баланың ми қызметін, зейінін, есте сақтауын, ойлауын және қимыл үйлесімділігін дамытуға бағытталған жаттығулар кешені.',
  'Salt Room': 'Тұзды шахта',
  'A comfortable space for relaxation and quiet activities in a salt environment, where children can rest and enjoy calm play.': 'Тұзды ортада тынығу мен релаксацияға арналған арнайы кеңістік. Балаларға жайлы атмосферада демалып, тыныш ойындармен айналысуға мүмкіндік береді.',
  'Book Therapy': 'Кітап терапиясы',
  'Using books and stories to help children understand emotions, develop imagination and build positive social and communication skills.': 'Кітаптар мен ертегілер арқылы баланың эмоциясын түсінуге, қиялын дамытуға және жағымды мінез-құлық дағдыларын қалыптастыруға көмектесетін бағыт.',
  'Karate': 'Каратэ',
  'A sports activity that supports physical development, coordination, agility, discipline, concentration and self-control.': 'Баланың дене белсенділігін, ептілігін, тәртібін, зейінін және өзін-өзі бақылау дағдыларын дамытуға арналған спорттық бағыт.',
  'Choreography': 'Хореография',
  'Music and movement activities that help develop rhythm, flexibility, coordination, confidence and creativity.': 'Музыка мен қимыл арқылы баланың ырғақ сезімін, икемділігін, үйлесімділігін және шығармашылық қабілетін дамыту.',
  'Group Speech Therapy': 'Топтық логопед',
  'Group sessions focused on speech development, correct pronunciation, vocabulary expansion and communication skills.': 'Балалардың сөйлеу тілін дамытуға, дыбыстарды дұрыс айтуға, сөздік қорын молайтуға және өз ойын еркін жеткізуіне бағытталған топтық сабақтар.',
  'Robotics and STEAM': 'Робототехника (STEAM)',
  'Engaging activities combining construction, technology, engineering and creativity. They encourage logical, spatial and creative thinking.': 'Құрастыру, технология, инженерия және шығармашылықты біріктіретін қызықты сабақтар. Балалардың логикалық және кеңістіктік ойлауын дамытуға ықпал етеді.',
  'Glenn Doman Method': 'Глен Доман әдістемесі',
  'An early-development approach focused on stimulating children’s cognitive abilities through visual materials and structured activities.': 'Баланың ерте жастағы танымдық мүмкіндіктерін дамытуға бағытталған әдістеме. Көрнекі материалдар мен жүйелі жаттығулар арқылы баланың есте сақтау және қабылдау қабілеттерін ынталандырады.',  
  'Sensory Integration': 'Сенсорлық интеграция',
  'Activities designed to help children process sensory information and improve body awareness, balance and movement coordination.': 'Әртүрлі сезім мүшелерінен келетін ақпаратты қабылдау және өңдеу дағдыларын дамытуға бағытталған жаттығулар. Қимыл үйлесімділігі мен денені сезіну қабілетін жетілдіруге көмектеседі.',
  'Art Therapy': 'Арт-терапия',
  'Creative activities such as drawing, modeling and working with colors that encourage emotional expression, imagination and creativity.': 'Сурет салу, мүсіндеу, бояу және шығармашылық жұмыстар арқылы баланың эмоциясын білдіруіне, қиялын және шығармашылық қабілетін дамытуына мүмкіндік береді.',
  ...
  ru: {
    ...
    'Developmental Programs': 'Развивающие направления',
    'Subjects We Teach':'Дополнительные уроки','Our comprehensive curriculum covers all developmental domains through play-based and structured learning.':'Наша комплексная учебная программа охватывает все сферы развития благодаря сочетанию игровых и структурированных форм обучения.',
'Neuro Development': 'Нейро направление',
'A set of activities designed to support children’s attention, memory, thinking, coordination and cognitive development.': 'Комплекс упражнений, направленных на развитие внимания, памяти, мышления, координации движений и познавательных навыков ребёнка.',
'Salt Room': 'Соляная шахта',
'A comfortable space for relaxation and quiet activities in a salt environment, where children can rest and enjoy calm play.': 'Специальное пространство для спокойного отдыха и релаксации в комфортной соляной атмосфере. Детям предлагаются спокойные игры и занятия.',
'Book Therapy': 'Книготерапия',
'Using books and stories to help children understand emotions, develop imagination and build positive social and communication skills.': 'Работа с книгами и сказками, которая помогает ребёнку лучше понимать эмоции, развивать воображение и формировать полезные социальные навыки.',
'Karate': 'Карате',
'A sports activity that supports physical development, coordination, agility, discipline, concentration and self-control.': 'Спортивное направление для развития физической активности, ловкости, координации, дисциплины, внимания и навыков самоконтроля.',
'Choreography': 'Хореография',
'Music and movement activities that help develop rhythm, flexibility, coordination, confidence and creativity.': 'Занятия музыкой и движением для развития чувства ритма, гибкости, координации и творческих способностей ребёнка.',
'Group Speech Therapy': 'Групповой логопед',
'Group sessions focused on speech development, correct pronunciation, vocabulary expansion and communication skills.': 'Занятия, направленные на развитие речи, правильного звукопроизношения, расширение словарного запаса и формирование навыков общения.',
'Robotics and STEAM': 'Робототехника (STEAM)',
'Engaging activities combining construction, technology, engineering and creativity. They encourage logical, spatial and creative thinking.': 'Увлекательные занятия, объединяющие конструирование, технологии, инженерию и творчество. Развивают логическое, пространственное и творческое мышление.',
'Glenn Doman Method': 'Методика Глена Домана',
'An early-development approach focused on stimulating children’s cognitive abilities through visual materials and structured activities.': 'Методика, направленная на развитие познавательных возможностей ребёнка в раннем возрасте. Использование наглядного материала и систематических занятий стимулирует память и восприятие.',
'Sensory Integration': 'Сенсорная интеграция',
'Activities designed to help children process sensory information and improve body awareness, balance and movement coordination.': 'Упражнения для развития способности воспринимать и обрабатывать информацию, поступающую через органы чувств. Способствует улучшению координации и осознания собственного тела.',
'Art Therapy': 'Арт-терапия',
'Creative activities such as drawing, modeling and working with colors that encourage emotional expression, imagination and creativity.': 'Творческие занятия: рисование, лепка, работа с цветом и различные виды творчества, которые помогают ребёнку выражать эмоции, развивать воображение и творческие способности.',
    ...
    '📅 Events': '📅 События', 'Upcoming Events': 'Ближайшие события', 'Exciting activities, celebrations, and learning opportunities happening soon!': 'Скоро — интересные занятия, праздники и новые возможности для обучения!','Events':'События','Class hour':'Классный час', 'Autumn Ball': 'Осенний балл', 'The kindergarten was beautifully decorated with colorful autumn leaves, flowers, fruits, and seasonal decorations. Our little ones dressed up in lovely autumn-themed costumes and took part in a special celebration dedicated to the beauty and richness of the autumn season.': 'Детский сад будет красиво украшен разноцветными осенними листьями, цветами, фруктами и сезонными декорациями. Наши малыши нарядились в красивые костюмы на осеннюю тематику и приняли участие в особенном празднике, посвящённом красоте и богатству осеннего времени года.', 'Details coming soon': 'Подробности скоро', 'New Year': 'Новый год', 
    'Our kindergarten will celebrate the New Year with joy, music, dancing, fun games, and beautiful costumes. It will be a magical day full of smiles and wonderful memorie': 'В нашем детском саду пройдёт весёлый новогодний праздник с музыкой, танцами, играми и красивыми костюмами. Этот день будет наполнен улыбками, радостью и прекрасными воспоминаниями.', 
    'Nauryz': 'Наурыз', 'Our kindergarten will welcome Nauryz with a joyful celebration of spring, friendship, and Kazakh traditions. The children will enjoy traditional games, music, dancing, and a festive atmosphere.': 'В нашем детском саду мы встретим Наурыз ярким праздником весны, дружбы и казахских традиций. Детей ждут национальные игры, музыка, танцы и праздничная атмосфера.',
    'Day of Knowledge':'День Знаний','Day of Language':'День Языка','Day of Republic':'День Республики','Independence Day':'День Независимости','Thanksgiving Day':'День Благодарение',
...
document.querySelectorAll('.event-type-btn').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    document.getElementById('eventsPanel').style.display = type === 'events' ? 'grid' : 'none';
    document.getElementById('classHourPanel').style.display = type === 'classHour' ? 'grid' : 'none';
  });
});
document.querySelectorAll('.schedule-group-btn').forEach((button) => {
